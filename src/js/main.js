(function ($) {
  ...
  function OtherJs() {
    const getPath = sessionStorage.getItem("currentTab") || "/";
    ...
    $(document).ready(function ($) {
      ...
      try {
        $(
          ".cm-menu-overlay, .cm-close-icon, .light-mode, .dark-mode, .cm-menu ul li a.link"
        ).on("click", function () {
    ...
    //   console.log(getPath, "<<<<<<<<<<<<<<path", window.location.pathname);
